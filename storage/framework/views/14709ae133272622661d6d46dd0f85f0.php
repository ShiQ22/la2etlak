...
<?php if($translatable && config('larapen.admin.show_translatable_field_icon')): ?>
	<i class="fa-solid fa-flag-checkered pull-<?php echo e(config('larapen.admin.translatable_field_icon_position')); ?>" title="<?php echo e(trans('admin.field_translatable')); ?>"></i>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\resources\views/admin/panel/fields/inc/translatable_icon.blade.php ENDPATH**/ ?>