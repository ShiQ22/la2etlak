				...
				<div class="ms-auto">
					<ul class="list-inline mb-0 ms-auto text-end">
						<li class="list-inline-item">
							<h5><i class="fa-solid fa-circle" style="color: #398bf7;"></i> <?php echo e(trans('admin.Activated')); ?></h5>
						</li>
						<li class="list-inline-item">
							<h5><i class="fa-solid fa-circle" style="color: #dddddd;"></i> <?php echo e(trans('admin.Unactivated')); ?></h5>
						</li>
					</ul>
				</div>
			</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\resources\views/admin/dashboard/charts/morris/bar/latest-users.blade.php ENDPATH**/ ?>