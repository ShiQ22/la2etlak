<?php
	...
	$showIconOnly ??= false;
?>
<?php if($isLangOrCountryCanBeSelected || isSettingsAppDarkModeEnabled()): ?>
				...
				<?php if($isLangOrCountryCanBeSelected): ?>
					<div class="">
						<a href="#selectLanguage"
						   ...
						   title="<?php echo e(t('change_language')); ?>"
						>
							<i class="bi bi-translate"></i> <?php echo e($currentLanguageName); ?> <i class="bi bi-chevron-expand"></i>
						</a>
					</div>
				<?php endif; ?>
			</div>
...
<?php $__env->startSection('modal'); ?>
	<?php echo $__env->make('front.layouts.partials.modal.languages', ['modalSize' => 'modal-lg', 'itemClass' => 'text-center'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
<?php /**PATH C:\xampp\htdocs\resources\views/auth/layouts/partials/select-language.blade.php ENDPATH**/ ?>