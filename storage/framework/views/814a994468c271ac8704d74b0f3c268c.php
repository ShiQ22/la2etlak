...
?>
<?php if(!empty($socialLoginProviders)): ?>
	<?php
		$sGutter = 'gx-2 gy-2';
	...
	<?php if($position == 'bottom'): ?>
		<div class="d-flex align-items-center my-4">
			...
			<span class="mx-2 text-2 text-muted fw-300"><?php echo e($bottomSeparator); ?></span>
			<hr class="flex-grow-1">
		</div>
	<?php endif; ?>
	<?php if($position == 'topWithTitle'): ?>
		<div class="d-flex align-items-center my-4">
			<hr class="flex-grow-1">
			<span class="mx-2 text-2 text-muted fw-300"><?php echo e($topSeparator); ?></span>
			<hr class="flex-grow-1">
		</div>
	<?php endif; ?>
	<?php if($page != 'modal' && !in_array($position, ['bottom', 'topWithTitle'])): ?>
		<div class="d-flex align-items-center my-3"></div>
	<?php endif; ?>
	
	<div class="row mb-3 social-media d-flex justify-content-center <?php echo e($sGutter); ?>">
		<?php $__currentLoopData = $socialLoginProviders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider => $providerData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<?php
			...
			?>
			<div class="<?php echo e($sCol); ?> col-sm-12 col-12 d-grid">
				<div class="col-xl-12 col-md-12 col-sm-12 col-12 btn <?php echo e($btnClass); ?>">
					<a href="<?php echo e($url); ?>" title="<?php echo $title; ?>">
						<i class="<?php echo e($iconClass); ?>"></i> <?php echo $label; ?>
	...
	<?php if($position == 'topWithTitle'): ?>
		<div class="d-flex align-items-center my-4">
			<hr class="flex-grow-1">
			<span class="mx-2 text-2 text-muted fw-300"><?php echo e(trans('auth.or')); ?></span>
			<hr class="flex-grow-1">
		</div>
	<?php endif; ?>
	<?php if($position == 'top'): ?>
	...
	<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\resources\views/auth/login/partials/social.blade.php ENDPATH**/ ?>