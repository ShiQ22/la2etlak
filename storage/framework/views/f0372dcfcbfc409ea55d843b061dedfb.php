...
/* === Skin === */
	...
	.skin .select2-container--bootstrap-5 .select2-dropdown .select2-search .select2-search__field:focus {
		border-color: <?php echo e($primaryBgColor); ?>;
		box-shadow: 0 0 0 .25rem <?php echo e(rgbToCss(hexToRgba($primaryBgColor, 0.25))); ?>;
	}
	...
	.skin .select2-container--bootstrap-5.select2-container--open .select2-selection {
		border-color: <?php echo e($primaryBgColor); ?> !important;
		box-shadow: 0 0 0 .25rem <?php echo e(rgbToCss(hexToRgba($primaryBgColor, 0.25))); ?> !important;
	}
...
<?php /**PATH C:\xampp\htdocs\resources\views/front/common/css/skin.blade.php ENDPATH**/ ?>