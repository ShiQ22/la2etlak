...
function getMetaTag(?string $page): array
{
	...
	if (config('plugins.domainmapping.installed')) {
		$domainMappingClass = '\extras\plugins\domainmapping\Domainmapping';
		if (class_exists($domainMappingClass)) {
			/** @var \extras\plugins\domainmapping\Domainmapping $domainMappingClass */
...
function getFormBorderRadiusCSS($formBorderRadius, $fieldsBorderRadius): string
{
	...
	if (config('lang.direction') == 'rtl') {
		$out .= '#homepage .search-row .search-col:first-child div.form-control {' . "\n";
