...
class ThemeDetector {
	...
	#applyDarkMode() {
		...
		if (this.#isFromAdminPanel) {
			...
			const logoDarkEl = document.querySelector('.navbar-brand .dark-logo');
			if (logoDarkEl) {
				logoDarkEl.classList.remove('d-none');
				if (!logoDarkEl.classList.contains('d-block')) {
					logoDarkEl.classList.add('d-block');
				}
			}
			const logoLightEl = document.querySelector('.navbar-brand .light-logo');
			if (logoLightEl) {
				logoLightEl.classList.remove('d-block');
				if (!logoLightEl.classList.contains('d-none')) {
					logoLightEl.classList.add('d-none');
				}
			}
		}
	...
	#removeDarkMode() {
		...
		if (this.#isFromAdminPanel) {
			...
			const logoDarkEl = document.querySelector('.navbar-brand .dark-logo');
			if (logoDarkEl) {
				logoDarkEl.classList.remove('d-block');
				if (!logoDarkEl.classList.contains('d-none')) {
					logoDarkEl.classList.add('d-none');
				}
			}
			const logoLightEl = document.querySelector('.navbar-brand .light-logo');
			if (logoLightEl) {
				logoLightEl.classList.remove('d-none');
				if (!logoLightEl.classList.contains('d-block')) {
					logoLightEl.classList.add('d-block');
				}
			}
		}
	...
	updateThemeSwitcher(themeSwitcherEl, selectedTheme = null) {
		...
		menuItemsEls.forEach(item => {
			...
			let itemLabel = item.innerHTML.trim();
			
			if (this.#showIconOnly) {
				const icon = item.querySelector('i');
				if (icon) {
					itemLabel = icon.outerHTML;
				}
			}
			...
			if (doesSwitcherCanBeUpdated) {
				...
				buttonEl.innerHTML = DOMPurify.sanitize(itemLabel);
