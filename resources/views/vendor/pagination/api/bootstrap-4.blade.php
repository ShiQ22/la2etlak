...
@if ($totalEntries > 0 && $isPageable)
    <ul class="pagination justify-content-center mb-0" role="navigation">
        ...
        @else
            <li class="page-item">
                <a class="page-link" href="{{ data_get($paginator, 'prev') }}" rel="prev" aria-label="@lang('pagination.previous')">
                    &lsaquo;
                </a>
            </li>
        @endif
        ...
        @if (data_get($paginator, 'next'))
            <li class="page-item">
                <a class="page-link" href="{{ data_get($paginator, 'next') }}" rel="next" aria-label="@lang('pagination.next')">
                    &rsaquo;
                </a>
            </li>
        @else
