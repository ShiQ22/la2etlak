...
<div class="row search-row">
	{{-- q --}}
	<div class="col-md-5 col-sm-12 px-0 mb-1 search-col">
		<div class="hstack gap-0 form-control form-control-lg rounded-5 border-5 border-primary py-1">
	...
	<div class="col-md-5 col-sm-12 px-0 mb-1 search-col">
		...
		<input type="hidden" id="mlSearch" name="l" value="">
	</div>
	
	{{-- button --}}
	<div class="col-md-2 col-sm-12 px-0 d-grid search-col">
		<button class="btn btn-lg btn-primary bg-gradient rounded-5 border-4 border-primary">
