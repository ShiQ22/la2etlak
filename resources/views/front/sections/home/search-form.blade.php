			...
			@if ($hideForm != '1')
				<div class="row d-flex justify-content-center">
					<div class="col-9">
						...
						>
							{{-- Hide on screens smaller than md (Show from sm to lower) --}}
							<div class="w-100 d-none d-md-inline-block">
								@include('front.sections.home.search-form.large-screen')
							</div>
							{{-- Show on screens smaller than md (Hide from sm to lower) --}}
							<div class="w-100 d-sm-inline-block d-md-none">
								@include('front.sections.home.search-form.small-screen')
							</div>
						</form>
					</div>
				</div>
