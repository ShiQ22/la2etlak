...
<footer>
	...
	<div class="container-fluid border-top bg-body-tertiary pt-5 pb-0 mt-4">
		<div class="{{ $containerClass . $containerPxClass }} my-0">
										...
										<div class="row">
											@if (config('settings.other.ios_app_url'))
												<div class="col-12 col-sm-6">
													<a class="" target="_blank" href="{{ config('settings.other.ios_app_url') }}">
			...
			{{-- Copyright Info --}}
			<div class="row">
				<div class="col-12 small text-center{{ $borderTopCopy . $mbCopy . $mtCopy }}">
					&copy; {{ date('Y') }} {{ config('settings.app.name') }}. {{ t('all_rights_reserved') }}.
