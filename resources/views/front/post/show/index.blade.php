		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					@endphp
					<div class="container border rounded bg-body-tertiary px-3 pt-2 pb-3 mb-sm-3 items-details-wrapper" style="{{ $overflowStyle }}">
						{{-- Title --}}
						<div class="clearfix">
...
@section('after_scripts')
	<script>
        ...
        var selectedCats  = @json($categoryIds);
        var selectedNames = @json($categoryNames);
